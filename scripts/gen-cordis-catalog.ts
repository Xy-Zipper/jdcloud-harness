...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  jdcloudAuthController: 'credentials.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  browserSession: 'request-local browser identity service — packages/client/connection/README.md owns the API',
  ...
  sidebarPanels: 'client-side panel visibility policies — packages/client/ui-sidebar/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  JdcloudAuthStatus: 'credentials.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  WorkspaceCreateOptions: 'workspace registration options are owned by packages/workspace/workspace/README.md',
