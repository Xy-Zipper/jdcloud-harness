...
| `ctx.jdcloudAuthController` | `core` | [`api-jdcloud-auth-controller`](../packages/api/jdcloud-auth-controller) | - | - | - | Owns password login, durable token storage, and tenant validation before browser prompts enter a Session. |
