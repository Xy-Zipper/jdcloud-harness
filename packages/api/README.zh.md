...
| [`jdcloud-auth-controller/`](jdcloud-auth-controller/README.zh.md) | 拥有可选的 JDCloud 登录、Host token 与管理员状态，以及 Prompt 和模型选择准入。 | `ctx.jdcloudAuthController` / `ctx.remote.jdcloudAuth` |
