...
| [`jdcloud-auth-controller/`](jdcloud-auth-controller/README.md) | Owns optional JDCloud password login, Host token storage, and browser-prompt validation. | `ctx.jdcloudAuthController` / `ctx.remote.jdcloudAuth` |
