...
| [`jdcloud-auth-controller/`](jdcloud-auth-controller/README.md) | Owns optional JDCloud login, Host token and administrator state, and prompt and model-selection admission. | `ctx.jdcloudAuthController` / `ctx.remote.jdcloudAuth` |
