...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'policyOf(session: Session): ApprovalPolicy',
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Authenticate one frontend index request, or allow it when browser authentication is disabled.',
      ...
      },
      {
        ...
        description: 'Add the fresh process token when browser authentication is enabled.',
