...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'main.conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-jdcloud-login JdcloudBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-jdcloud-lowcode-actions LowcodeActionPicker id \'jdcloud-lowcode-actions\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional authenticated-account summary below the brand row.',
    doc: 'Optional authenticated-account summary below the brand row. Feature\npackages own its identity data and actions; the shell supplies only\nthe wide-versus-rail presentation state.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [
      'client-ui-jdcloud-login AccountSeat',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-jdcloud-login JdcloudBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
