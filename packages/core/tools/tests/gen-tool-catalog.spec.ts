...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'jdcloud_lowcode_create', 'jdcloud_lowcode_create_table', 'jdcloud_lowcode_delete',
      'jdcloud_lowcode_describe', 'jdcloud_lowcode_get', 'jdcloud_lowcode_query',
      'jdcloud_lowcode_update', 'jdcloud_lowcode_upload_file',
