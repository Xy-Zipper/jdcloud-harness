...
export const en = {
  nav: 'Models',
  title: 'Models',
  intro: 'View configured model providers and edit their settings when this deployment allows it.',
  edit: 'Edit',
  ...
  readOnly: 'Model settings are managed by this server and are read-only in this browser.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  readOnly: '模型设置由服务器统一管理，当前浏览器仅可查看。',
