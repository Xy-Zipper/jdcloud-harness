...
export const zh = {
  ...
  transferLoading: '正在验证登录信息…',
  transferErrorTitle: '登录信息无效',
  transferErrorDescription: '请返回来源页面重新进入，或使用账号密码登录。',
  transferGoLogin: '前往登录',
...
export const en: Record<JdcloudLoginKey, string> = {
  ...
  transferLoading: 'Validating sign-in information…',
  transferErrorTitle: 'Invalid sign-in information',
  transferErrorDescription: 'Return to the source page and try again, or sign in with your account and password.',
  transferGoLogin: 'Go to sign in',
